...
sideMenuBtn.addEventListener('click',function(){
    sideMenuModal.classList.add('openSideMenuModal') // Opens deposit modal on click of deposit button
})
    ...
    depositBtn.addEventListener('click',function(){
        if(activeUser == undefined) { // Checks activeUser
            ...
            depositForm.addEventListener('submit', function(e){
                ...
                console.log("activeUser.balance: " + activeUser.balance + "depositAmountInput:" + depositAmountInput);
                ...
                alert(`xxxSuccessfuly deposited PHP ${depositAmountInput}`);
                // depositForm.reset();
